 ...
 */
public class SetCategoryConcernAdapter extends AbstractAdapter<User.UserSetCategory> {


    @Inject
    public SetCategoryConcernAdapter(Context context) {
        super(context);
    }
